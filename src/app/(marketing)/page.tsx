    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-24 sm:py-32">
        <h1 className="text-4xl sm:text-6xl font-display font-bold tracking-tight text-foreground max-w-3xl animate-fade-up">
          Gestión digital de vehículos y flotas,{" "}
          <span className="text-primary">en un solo lugar.</span>
        </h1>

        <p
          className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl animate-fade-up"
          style={{ animationDelay: "100ms" }}
        >
          Digitalizá el historial clínico de tus autos. Llevá el registro de
          mantenimientos, gastos y alertas de tu flota estés donde estés.
        </p>
        ...
        >
          ...
          <Button
            ...
            asChild
          >
            <Link href="/sign-up">Registrar cuenta</Link>
          </Button>
